...
const calculator = {
  ...
  memory: null,
  //
  plussMinusBtn: document.getElementById(`plus/minus-btn`),
  ...
  mPlussBtn: document.getElementById(`m+-btn`),
  mMinusBtn: document.getElementById(`m--btn`),
  dotBtn: document.getElementById(`dot-btn`),
  addBtn: document.getElementById(`add-btn`),
  memBtn: document.getElementById(`mr-btn`),
  memTxt: document.getElementById(`memory`),
